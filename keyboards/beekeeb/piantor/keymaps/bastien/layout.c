...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_split_3x6_3(
	      ES_Z,    ES_Q,    ES_C,  ES_N,  ES_D,   LT(_FUN, ES_K),                    LT(_MEDIA, ES_J),  ES_U,     ES_O,      ES_G,    ES_X,   KC_TAB,
            KC_BSPC,   ES_P,    ES_S,  ES_R,  ES_T,   ES_V,                                ES_Y,      ES_I,     ES_A,     ES_L,    ES_H,    KC_DEL,
     TD(TD_CIRC_DIAE),    ES_W,    ES_F,  ES_B,  ES_M,   TD(TD_GRV_ACUT),                       KC_TAB,         ES_COMM,  E_AIGU,    ES_DOT,  ES_MINS, ES_PLUS,
                        	      KC_ESCAPE, MT(MOD_LCTL, KC_SPACE), OSL(_SYM),            OSM(MOD_LSFT),  LT(_NAV, ES_E),  KC_ENTER
			     ),
    [_SYM] = LAYOUT_split_3x6_3(
	    ...
	    ES_DIAE,   XXXXXXX,   ES_BSLS,   ES_PIPE,   ES_SLSH,    ES_ACUT,                ES_PERC,  ES_HASH,   E_CIRC,   ES_COLN,  ES_UNDS,  ES_EURO,
    ...
    [_FUN] = LAYOUT_split_3x6_3(
            XXXXXXX,     XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,                   XXXXXXX,    KC_F4,    KC_F5,    KC_F6,    KC_F11,    DT_UP,
	    XXXXXXX,     XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,   XXXXXXX,                   XXXXXXX,    KC_F1,    KC_F2,    KC_F3,    KC_F10,    DT_PRNT,
